...
class SetupViewModel(private val userRepository: UserRepository) : ViewModel() {
...
class SetupViewModelFactory(val repository: UserRepository) : ViewModelProvider.Factory {
